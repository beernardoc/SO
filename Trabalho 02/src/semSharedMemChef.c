...
static void waitForOrder ()
{
    ...
    /* insert your code here */
    // pedido
    sh->fSt.st.chefStat = COOK; // o chef esta a cozinhar
 ...
 */
static void processOrder () // faz o pedido e entrega da comida ao waiter
{
    ...
    sh->fSt.st.chefStat = REST; // ja nao há pedido --> chef descança
